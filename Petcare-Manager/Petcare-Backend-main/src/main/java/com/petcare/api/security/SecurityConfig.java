    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/veterinarios/**").hasAnyRole("ADMIN", "FUNCIONARIO")
                        .requestMatchers("/api/veterinarios/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/clientes/**").hasAnyRole("ADMIN", "FUNCIONARIO", "VET")
                        .requestMatchers("/api/clientes/**").hasAnyRole("ADMIN", "FUNCIONARIO")
                        .requestMatchers(HttpMethod.GET, "/api/pets/**").hasAnyRole("ADMIN", "FUNCIONARIO", "VET")
